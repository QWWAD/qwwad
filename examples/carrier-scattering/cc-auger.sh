...
Results have been written to $OUTsr in the format:
  ...
  COLUMN 1 - Applied electric field [kV/cm]
  COLUMN 2 - Average |2,2> -> |2,1> scattering rate [s^{-1}]
  COLUMN 3 - Average |2,2> -> |1,1> scattering rate [s^{-1}]
  COLUMN 4 - Average |2,1> -> |1,1> scattering rate [s^{-1}]
