...
# Alloy disorder scattering for an infinite QW with varying alloy composition
#
...
rate12=`awk '/^1 2/{print $3}' ado-avg.dat`
rate11=`awk '/^1 1/{print $3}' ado-avg.dat`
printf "%f %e %e %e %e\n" $x $rate22 $rate21 $rate12 $rate11 >> $outfile
done
