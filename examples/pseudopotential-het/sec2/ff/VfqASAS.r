...
@timestamp def "Fri Sep 25 15:46:42 1998"
@with g0
@g0 on
@g0 label off
@g0 hidden false
...
@    yaxis  tick minor 0.02
@    yaxis  tick offsetx 0.000000
@    yaxis  tick offsety 0.000000
@    yaxis  label "\8D\0\2V\sf\N\0(\2q\0) (eV)"
...
@    zeroxaxis  ticklabel format exponential
